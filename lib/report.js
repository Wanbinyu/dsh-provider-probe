import { FAILURE_ADVICE_EN } from "./failure.js";
...
export function buildDiagnosticReport(result, inputModalities, localizedFailureAdvice) {
    const lines = [
